...
// /* -----------------------------------------
//    GET: Fetch ALL users (admins, monitors, faculties, students)
// ----------------------------------------- */
...
//     res.json({ success: true, message: "Login successful", role: userType, user });
//   } catch (err) {
//     console.error(err);
//     res.status(500).json({ success: false, message: "Server error" });
//   }
...
// /* -----------------------------------------
//    ADD SINGLE USER
//    /api/users/add-single
// ----------------------------------------- */
// /**
// * POST /api/users/add
// * Add multiple users (admins, monitors, faculties, students)
// */
// router.post("/add", async (req, res) => {
//   try {
//     const usersData = req.body;

//     let existing = await UsersModel.findOne();
//     if (!existing) {
//       const newUsers = new UsersModel(usersData);
//       await newUsers.save();
//       return res.status(201).json({ success: true, message: "Users added successfully!" });
//     } else {
//       ["admins", "monitors", "faculties", "students"].forEach((type) => {
//         if (usersData[type] && usersData[type].length > 0) {
//           existing[type] = existing[type].concat(usersData[type]);
//         }
//       });
//       await existing.save();
...
// // /**
// //  * PUT /api/users/edit
// //  * Edit user by userType + registration_no
// //  */
// // router.put("/edit", async (req, res) => {
// //   const { userType, registration_no, updatedData } = req.body;
...
// //     const index = users[userType].findIndex(u => u.registration_no === registration_no);
// //     if (index === -1) {
// //       return res.status(404).json({ success: false, message: "User not found" });
// //     }

// //     Object.assign(users[userType][index], updatedData);
// //     await users.save();
...
// //  * Delete a user using userType + registration_no
// //  */
// // router.delete("/delete", async (req, res) => {
// //   const { userType, registration_no } = req.body;
...
// //     const oldLength = users[userType].length;

// //     users[userType] = users[userType].filter(
// //       user => user.registration_no !== registration_no
// //     );

// //     if (users[userType].length === oldLength) {
// //       return res.status(404).json({ success: false, message: "User not found" });
// //     }
